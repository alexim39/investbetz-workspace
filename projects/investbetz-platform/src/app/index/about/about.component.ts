...
@Component({
  ...
  template: `
    <div class="about-wrapper">
      ...
      <async-about-training></async-about-training>
      <async-about-story></async-about-story>
      <async-about-approach></async-about-approach>
      <async-mission-corevalues></async-mission-corevalues>
