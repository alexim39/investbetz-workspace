...
export class CardService {
  ...
  constructor(private depositService: DepositService, private http: HttpClient) { }
  ...
  public transactionId(): number{
    return this.depositService.generateDepositId();
  }

  public deposit(depositObj: DepositInterface): Observable<any> {
    const cardDepositUrl = `${this.domain}/api/Clients/card`;
    return this.http.post<DepositInterface>(cardDepositUrl, depositObj, httpOptions)
    .pipe(
